...
Discord上の名前とwarzoneレートサイト上の名前の類似性スコアが低い場合は**[Discord上の名前]が入力される。
類似性スコアが高くても、そっくりさんは誤って入力される可能性がある。
...
この機能は似たものを見つけるためのrapidfuzzライブラリを使用していて、
Discord上の名前とlasuaoeレートサイト上の名前の類似性スコアが低い場合は**[Discord上の名前]が入力される。
類似性スコアが高くても、そっくりさんは誤って入力される可能性がある。
